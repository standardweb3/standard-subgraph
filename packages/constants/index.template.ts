...
export const MASTER_CHEF_V2_START_BLOCK = BigInt.fromString(
  '{{ masterchefV2.startBlock }}{{^masterchefV2.startBlock}}0{{/masterchefV2.startBlock}}'
)

export const UNISWAP_SUSHI_ETH_PAIR_FIRST_LIQUDITY_BLOCK = BigInt.fromI32(10750005)

export const SUSHI_WETH_PAIR_FIRST_LIQUIDITY_BLOCK = BigInt.fromString(
  '{{ sushi_weth_liquidity_block }}{{^sushi_weth_liquidity_block}}0{{/sushi_weth_liquidity_block}}'
)

export const USDC_WETH_PAIR_FIRST_LIQUIDITY_BLOCK = BigInt.fromString(
  '{{ usdc_weth_liquidity_block }}{{^usdc_weth_liquidity_block}}0{{/usdc_weth_liquidity_block}}'
)

export const SUSHI_USDC_PAIR_FIRST_LIQUIDITY_BLOCK = BigInt.fromString(
  '{{ sushi_usdc_liquidity_block }}{{^sushi_usdc_liquidity_block}}0{{/sushi_usdc_liquidity_block}}'
)
...
export const SUSHI_BAR_ADDRESS = Address.fromString(
  '{{ bar.address }}{{^bar.address}}0x0000000000000000000000000000000000000000{{/bar.address}}'
)
...
export const USDC_WETH_PAIR_ADDRESS = Address.fromString(
  '{{ usdc_weth_pair }}{{^usdc_weth_pair}}0x0000000000000000000000000000000000000000{{/usdc_weth_pair}}'
)
...
export const DAI_WETH_PAIR_ADDRESS = Address.fromString(
  '{{ dai_weth_pair }}{{^dai_weth_pair}}0x0000000000000000000000000000000000000000{{/dai_weth_pair}}'
)
