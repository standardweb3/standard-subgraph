...
import { BIG_DECIMAL_1E18, BIG_DECIMAL_ZERO, BIG_INT_ZERO, FACTORY_ADDRESS, MTR_ADDRESS, V1_ADDRESS, VAULT_MANAGER_ADDRESS } from 'const'
import { Vault, VaultManager  } from '../../generated/schema'
...
export function initializeVaultManager(): VaultManager {
    ...
    if (!vaultManagerContractDesiredSupply) {
